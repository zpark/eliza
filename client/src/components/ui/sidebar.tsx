        ...
        return (
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className="flex m-4 rounded-md border h-full w-full flex-col bg-card group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
                    >
                        {children}
                    </div>
                </div>
