...
- fix: Fixing failling tests token.test.ts and videoGeneration.test.ts [\#465](https://github.com/elizaos/eliza/pull/465) ([elizaos-demirix](https://github.com/elizaos-demirix))
...
- feat: Adding unit tests for start - Covering goals, defaultCharacters, relationships, evaulators, posts, database, messages [\#367](https://github.com/elizaos/eliza/pull/367) ([elizaos-demirix](https://github.com/elizaos-demirix))
...
- fix: Build error for packages requiring @elizaos/eliza [\#331](https://github.com/elizaos/eliza/pull/331) ([shakkernerd](https://github.com/shakkernerd))
