...
import type { Entity, Memory, Component, Room, UUID, Content, AgentRuntime, ChannelType } from '@elizaos/core';
...
describe('Base Adapter Methods Integration Tests', () => {
    ...
    describe('CRUD Operations', () => {
        ...
        it('should handle updateComponent', async () => {
            ...
            // Verify update
            const retrieved = await adapter.getComponent(testEntityId, 'relationship', worldId, sourceEntityId);
        ...
        it('should handle component operations with complex params', async () => {
            ...
            await adapter.createComponent(component);
            const retrieved = await adapter.getComponent(testEntityId, 'inventory', worldId, sourceEntityId);
