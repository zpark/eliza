...
describe('Prompts', () => {
  ...
  describe('Template Consistency', () => {
    ...
    it('all templates should have consistent XML output format instructions', () => {
      templates.forEach((template) => {
        ...
        expect(template).toContain('IMPORTANT: Your response must ONLY contain the <response></response> XML block');
      });
    });
  ...
  describe('Template Placeholders', () => {
    it('should use consistent placeholder format', () => {
      ...
      [...shouldRespondPlaceholders, ...messageHandlerPlaceholders, ...postCreationPlaceholders].forEach(placeholder => {
