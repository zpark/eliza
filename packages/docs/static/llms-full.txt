...
import { PGlite } from '@electric-sql/sqlite';
...
> Note: at time of publishing, use `npm create eliza` until main version is uploaded
...
````json
{
  ...
  "scripts": {
    ...
    "dev": "turbo run start --filter=./packages/cli",
