        ...
        schema: {
          ...
          properties: {
            ...
            server_id: {
              type: 'string',
              format: 'uuid',
              description: 'ID of the server (default: 00000000-0000-0000-0000-000000000000)',
            },
            author_id: {
              type: 'string',
              format: 'uuid',
              description: 'ID of the author (agent ID)',
            },
            ...
            metadata: {
              type: 'object',
              description:
                'Additional metadata (should include agent_name if author_id is agent ID)',
            },
          },
        },
      },
