...
describe('UI Disable Feature Integration', () => {
    ...
    describe('Environment Variable Behavior', () => {
        ...
        it('should handle combined NODE_ENV and ELIZA_UI_ENABLE scenarios', () => {
            ...
            testScenarios.forEach(([nodeEnv, elizaUIEnable, expected, description]) => {
                ...
                const uiEnabled = elizaUIEnable !== undefined
    ...
    describe('Security Implications', () => {
        ...
        it('should ensure API functionality remains intact when UI disabled', () => {
            ...
            const mockRouter = {
                routes: [] as string[],
                get: function (path: string) { this.routes.push(`GET ${path}`); },
                post: function (path: string) { this.routes.push(`POST ${path}`); },
                delete: function (path: string) { this.routes.push(`DELETE ${path}`); },
            };
    ...
    describe('Documentation Consistency', () => {
        it('should match .env.example documentation patterns', () => {
            ...
            const envExamplePattern = {
                comment: '# Controls whether the web UI is served (default: enabled in development, disabled in production)',
                usage: '# Set to "true" to force enable, "false" to force disable, or leave unset for automatic behavior',
