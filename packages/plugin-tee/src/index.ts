import { IAgentRuntime, logger, type Plugin, TeePluginConfig, TeeVendorConfig } from '@elizaos/core';
...
export const teePlugin = (config?: TeePluginConfig): Plugin => {
    ...
    return {
        name: vendor.getName(),
        init: async (config: Record<string, string>, runtime: IAgentRuntime) => { return await initializeTEE(config, runtime); },
