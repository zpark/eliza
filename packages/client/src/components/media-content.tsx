    ...
    return (
      <div className={cn('relative rounded-lg bg-card border p-4', className)} style={{ maxWidth }}>
        <div className="flex items-center space-x-3 mb-3 overflow-hidden">
          ...
          <span className="text-sm text-primary font-medium truncate whitespace-nowrap overflow-hidden text-ellipsis">{title || 'Audio File'}</span>
        </div>
        {hasError ? (
  ...
  if (isPdfUrl(url)) {
    return (
      <div
        ...
        style={{ maxWidth }}
      >
        <div className="flex items-center justify-between p-3 bg-muted/50 border-b gap-16">
          <div className="flex items-center space-x-2 overflow-hidden">
            <FileText className="w-5 h-5 text-muted-foreground" />
            <span className="text-sm text-primary font-medium truncate whitespace-nowrap overflow-hidden text-ellipsis">{title || 'PDF Document'}</span>
          </div>
      ...
      <div className={cn('rounded-lg bg-card border p-4', className)} style={{ maxWidth }}>
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 overflow-hidden">
            <p className="text-sm text-primary font-medium truncate whitespace-nowrap overflow-hidden text-ellipsis">{title || 'Document'}</p>
