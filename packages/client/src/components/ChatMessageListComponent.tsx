    ...
    return (
        ...
        >
            ...
            {filteredMessages.map((message: UiMessage, index: number) => {
                ...
                const senderAgent = chatType === 'GROUP' && !isUser && getAgentInMessage ?
                    getAgentInMessage(message.senderId) : undefined;
                    ...
                    >
                        ...
                        >
                                    ...
                                    <AvatarImage
                                        src={
                                            chatType === 'DM'
                                                ...
                                                (agentAvatarMap && message.senderId ? agentAvatarMap[message.senderId] : null) ||
                                                '/elizaos-icon.png'
                                        }
                                    />
                                </Avatar>
                            ...
                            <MemoizedMessageContent
                                message={message}
                                agentForTts={chatType === 'DM' ? targetAgentData : (senderAgent as Agent | undefined)}
