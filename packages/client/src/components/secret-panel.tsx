        ...
        <div className="rounded-lg w-full">
            ...
            <div className="grid grid-cols-[1fr_2fr_auto] gap-4 items-end w-full pb-4">
                ...
                <div className="flex flex-col gap-1 relative">
                    <label className="ml-2 text-xs font-medium text-gray-400">VALUE</label>
                ...
                <Button className="shrink-0" onClick={addEnv}>Add</Button>
            </div>
                ...
                {envs.map((env, index) => (
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            {openIndex === index && (
                                <div className="absolute right-0 -top-2 mt-2 w-24 bg-muted border rounded shadow-md z-10" ref={dropdownRef}>
                                    <div 
