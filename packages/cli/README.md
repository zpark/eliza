...
| Command          | Subcommand             | Arguments & Options         | Purpose                                                         |
| ---------------- | ---------------------- | --------------------------- | --------------------------------------------------------------- |
| `create`         |                        |                             | Initialize a new ElizaOS project or plugin                      |
|                  |                        | `[name]`                    | Optional name for the new project or plugin directory           |
|                  |                        | `-d, --dir <dir>`           | Specify installation directory (default: current directory)     |
|                  |                        | `-y, --yes`                 | Skip confirmation prompts                                       |
|                  |                        | `-t, --type <type>`         | Type to create: 'project' or 'plugin'                           |
| `project`        | `list-plugins`         |                             | List available plugins for installation                         |
|                  |                        | `-t, --type <type>`         | Filter by plugin type (adapter, client, plugin)                 |
|                  | `add-plugin`           | `<plugin>`                  | Add a specified plugin to the current project                   |
|                  |                        | `--no-env-prompt`           | Skip prompting for environment variables                        |
|                  | `remove-plugin`        | `<plugin>`                  | Remove a specified plugin from the current project              |
| `setup-monorepo` |                        |                             | Clone the main ElizaOS monorepo locally                         |
|                  |                        | `-b, --branch <branch>`     | Specify branch to clone (default: 'v2-develop')                 |
|                  |                        | `-d, --dir <directory>`     | Specify destination directory (default: './eliza')              |
| `plugin`         | `publish`              |                             | Publish a plugin to a registry                                  |
...
| `agent`          | `list` (alias: `ls`)   |                             | List all available agents                                       |
|                  |                        | `-j, --json`                | Output in JSON format                                           |
|                  | `get` (alias: `g`)     |                             | Get details about a specific agent                              |
|                  |                        | `-n, --name <name>`         | Agent ID, name, or index to retrieve                            |
|                  |                        | `-j, --json`                | Output in JSON format                                           |
|                  |                        | `-o, --output <file>`       | Save configuration to file                                      |
|                  | `start` (alias: `s`)   |                             | Start a new agent instance                                      |
...
|                  | `stop` (alias: `st`)   |                             | Stop a specific agent                                           |
|                  |                        | `-n, --name <name>`         | Agent to stop (ID, name, or index)                              |
|                  | `restart` (alias: `r`) |                             | Restart a specific agent                                        |
|                  |                        | `-n, --name <name>`         | Agent to restart (ID, name, or index)                           |
| `start`          |                        |                             | Start the main ElizaOS server process                           |
...
| `stop`           |                        |                             | Stop all running ElizaOS processes initiated by the CLI         |
| `dev`            |                        |                             | Start the ElizaOS server in development mode with hot reloading |
|                  |                        | `-p, --port <port>`         | Specify development server port                                 |
| `update`         |                        |                             | Update all `@elizaos/*` dependencies in the current project     |
|                  |                        | `--check`                   | Check for updates without installing                            |
|                  |                        | `--skip-build`              | Skip automatic build after updating                             |
| `update-cli`     |                        |                             | Update the globally installed CLI package to the latest version |
| `test`           |                        |                             | Run tests for the current project or plugin                     |
...
| `env`            | `list`                 |                             | Show environment variables from both global and local scopes    |
|                  | `edit`                 |                             | Interactively edit environment variables                        |
|                  | `set`                  |                             | Set or update an environment variable                           |
|                  |                        | `<key> <value>`             | Key and value to set                                            |
|                  |                        | `--global` or `--local`     | Specify scope for the variable                                  |
|                  | `unset`                |                             | Remove an environment variable                                  |
|                  |                        | `<key>`                     | Key to remove                                                   |
|                  |                        | `--global` or `--local`     | Specify scope to remove from                                    |
|                  | `reset`                |                             | Clear all environment variables (requires confirmation)         |
|                  |                        | `--global` or `--local`     | Specify scope to reset                                          |
|                  | `set-path`             |                             | Set custom path for global environment file                     |
|                  |                        | `<path>`                    | Path to use for environment file                                |
| `publish`        |                        |                             | Publish the current project or plugin                           |
...
|                  |                        | `--all`                     | Display help for all commands                                   |
