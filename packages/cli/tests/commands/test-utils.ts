 ...
 */
export function runCliCommand(elizaosCmd: string, args: string, options: { timeout?: number } = {}): string {
 ...
 */
export function expectHelpOutput(output: string, command: string, expectedOptions: string[] = []): void {
