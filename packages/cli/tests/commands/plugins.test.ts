...
describe("ElizaOS Plugin Commands", () => {
  ...
  test("plugins add supports GitHub URL installation", async () => {
    ...
    execSync(`${elizaosCmd} plugins add https://github.com/fleek-platform/eliza-plugin-mcp --skip-env-prompt`, { 
      stdio: "pipe",
      timeout: 30000
    });
    ...
    execSync(`${elizaosCmd} plugins add github:elizaos-plugins/plugin-openrouter#1.x --skip-env-prompt`, { 
      stdio: "pipe",
      timeout: 30000
    });
