...
export class AgentServer {
    ...
    this.app.post(
      ...
      async (req: express.Request, res: express.Response) => {
        ...
        try {
          ...
          logger.error("cant serialize response", response.object);
      ...
      async (req: express.Request, res: express.Response) => {
        ...
        if (images.data && images.data.length > 0) {
          for (let i = 0; i < images.data.length; i++) {
            const caption = await agent.useModel(
    ...
    this.app.get(
      ...
      async (req: express.Request, res: express.Response) => {
        ...
        try {
          ...
          logger.log("File written successfully. Size:", stats.size, "bytes");
  ...
  public registerAgent(runtime: IAgentRuntime) {
    ...
    for (const route of runtime.routes) {
      ...
      switch (route.type) {
        case "GET":
          this.app.get(route.path, (req: any, res: any) =>
            route.handler(req, res)
          );
          break;
        case "POST":
          this.app.post(route.path, (req: any, res: any) =>
            route.handler(req, res)
          );
          break;
        case "PUT":
          this.app.put(route.path, (req: any, res: any) =>
            route.handler(req, res)
          );
          break;
        case "DELETE":
          this.app.delete(route.path, (req: any, res: any) =>
            route.handler(req, res)
          );
          break;
        default:
