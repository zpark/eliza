...
import { ModelClass, type GenerateTextParams, type Plugin } from '@elizaos/core';
...
describe('LocalAI Text Generation', () => {
  ...
  test('should attempt to download small model when using TEXT_SMALL', async () => {
    const result = await mockRuntime.useModel<GenerateTextParams>(ModelClass.TEXT_SMALL, {
  ...
  test('should attempt to download large model when using TEXT_LARGE', async () => {
    const result = await mockRuntime.useModel<GenerateTextParams>(ModelClass.TEXT_LARGE, {
  ...
  test('should handle download failure gracefully', async () => {
    ...
    await expect(mockRuntime.useModel<GenerateTextParams>(ModelClass.TEXT_SMALL, {
  ...
  test('should handle model switching', async () => {
    ...
    const smallResult = await mockRuntime.useModel<GenerateTextParams>(ModelClass.TEXT_SMALL, {
    ...
    // Then use TEXT_LARGE
    const largeResult = await mockRuntime.useModel<GenerateTextParams>(ModelClass.TEXT_LARGE, {
