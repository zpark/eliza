 ...
 */
export class DummyTranscriptionService extends Service implements ITranscriptionService {
  static override readonly serviceType = ITranscriptionService.serviceType;
  
  public readonly capabilityDescription = 'Dummy transcription service for testing';
  ...
  async transcribeAudio(audioPath: string | Buffer, options?: TranscriptionOptions): Promise<TranscriptionResult> {
  ...
  async transcribeVideo(videoPath: string | Buffer, options?: TranscriptionOptions): Promise<TranscriptionResult> {
  ...
  async speechToText(audioStream: NodeJS.ReadableStream | Buffer, options?: SpeechToTextOptions): Promise<TranscriptionResult> {
