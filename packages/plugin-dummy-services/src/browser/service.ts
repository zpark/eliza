 ...
 */
export class DummyBrowserService extends Service implements IBrowserService {
  static override readonly serviceType = IBrowserService.serviceType;
  
  public readonly capabilityDescription = 'Dummy browser automation service for testing';
  ...
  async extractContent(selector?: string): Promise<ExtractedContent> {
    ...
    if (isGitHub) {
      mockContent = {
        ...
        images: [
          { src: 'https://github.com/mock/repo/avatar.png', alt: 'Repository Avatar' }
        ],
      ...
      mockContent = {
        ...
        images: [
          { src: 'https://google.com/logo.png', alt: 'Google Logo' }
        ],
      ...
      mockContent = {
        ...
        images: [
          { src: `${this.currentUrl}/image.jpg`, alt: 'Mock Image' }
        ],
